  ...
  <head>
    ...
    ilio = {
      ...
      urls: [
        ...
        'https://easyforms.illinoislegalaid.org/start/Appearance/appearance/#/1',
        'https://easyforms.illinoislegalaid.org/start/AppearanceEfile/appearance',
        'https://easyforms.illinoislegalaid.org/start/AppearanceEfile/appearance/#/1',
        'https://easyforms.illinoislegalaid.org/start/AskDebtCollectorStopContact/stop_debt_collection',
        'https://easyforms.illinoislegalaid.org/start/AskDebtCollectorStopContact/stop_debt_collection/#/1',
        'https://easyforms.illinoislegalaid.org/start/CannabisExpungement/cannabis_expungement',
        'https://easyforms.illinoislegalaid.org/start/CannabisExpungement/cannabis_expungement/#/1',
        'https://easyforms.illinoislegalaid.org/start/CollectionProofLetter/collection_proof_debtor',
        'https://easyforms.illinoislegalaid.org/start/CollectionProofLetter/collection_proof_debtor/#/1',
        'https://easyforms.illinoislegalaid.org/start/EFilingExemptionAppellateCourt/e-filing_exemption_appellate_court',
        'https://easyforms.illinoislegalaid.org/start/EFilingExemptionAppellateCourt/e-filing_exemption_appellate_court/#/1',
        'https://easyforms.illinoislegalaid.org/start/EfilingExemptionCircuitCourt/e-filing_exemption',
        'https://easyforms.illinoislegalaid.org/start/EfilingExemptionCircuitCourt/e-filing_exemption/#/1',
        'https://easyforms.illinoislegalaid.org/start/EFilingExemptionSupremeCourt/e-filing_exemption_supreme_court',
        'https://easyforms.illinoislegalaid.org/start/EFilingExemptionSupremeCourt/e-filing_exemption_supreme_court/#/1',
        ...
        'https://easyforms.illinoislegalaid.org/start/IDHRHousingDiscriminationComplaint/housing_discrimination_complaint/#/1',
        'https://easyforms.illinoislegalaid.org/start/InterpreterRequest/interpreter_request',
        'https://easyforms.illinoislegalaid.org/start/InterpreterRequest/interpreter_request/#/1',
        'https://easyforms.illinoislegalaid.org/start/LivingWill/living_will',
        'https://easyforms.illinoislegalaid.org/start/LivingWill/living_will/#/1',
        ...
        'https://easyforms.illinoislegalaid.org/start/PersonnelFileRequest/personnel_file_request/#/1',
        'https://easyforms.illinoislegalaid.org/start/PowerOfAttorneyHealthCare/power_of_attorney_for_health_care',
        'https://easyforms.illinoislegalaid.org/start/PowerOfAttorneyHealthCare/power_of_attorney_for_health_care/#/1',
        'https://easyforms.illinoislegalaid.org/start/PowerOfAttorneyProperty/power_of_attorney_for_property',
        'https://easyforms.illinoislegalaid.org/start/PowerOfAttorneyProperty/power_of_attorney_for_property/#/1',
        'https://easyforms.illinoislegalaid.org/start/PowerOfAttorneyResignation/power_of_attorney_resignation',
        'https://easyforms.illinoislegalaid.org/start/PowerOfAttorneyResignation/power_of_attorney_resignation/#/1',
        'https://easyforms.illinoislegalaid.org/start/PowerOfAttorneyRevocation/power_of_attorney_revocation',
        'https://easyforms.illinoislegalaid.org/start/PowerOfAttorneyRevocation/power_of_attorney_revocation/#/1',
        'https://easyforms.illinoislegalaid.org/start/ProofOfDelivery/proof_of_delivery',
        'https://easyforms.illinoislegalaid.org/start/ProofOfDelivery/proof_of_delivery/#/1',
        ...
        'https://easyforms.illinoislegalaid.org/start/RequestTimeOffWorkDueToDomesticViolence/request_time_off_work_due_to_domestic_violence/#/1',
        'https://easyforms.illinoislegalaid.org/start/RespondToALawsuit/respond_to_a_lawsuit',
        'https://easyforms.illinoislegalaid.org/start/RespondToALawsuit/respond_to_a_lawsuit/#/1',
        'https://easyforms.illinoislegalaid.org/start/SecurityDepositDemand/security_deposit_demand_letter',
        'https://easyforms.illinoislegalaid.org/start/SecurityDepositDemand/security_deposit_demand_letter/#/1',
        'https://easyforms.illinoislegalaid.org/start/StopWageAssignment/stop_wage_assignment',
        'https://easyforms.illinoislegalaid.org/start/StopWageAssignment/stop_wage_assignment/#/1',
        'https://easyforms.illinoislegalaid.org/start/TODI/transfer_on_death_instrument',
        'https://easyforms.illinoislegalaid.org/start/TODI/transfer_on_death_instrument/#/1',
        'https://easyforms.illinoislegalaid.org/start/USCISApplications/main',
        'https://easyforms.illinoislegalaid.org/start/USCISApplications/main/#/1',
        'https://easyforms.illinoislegalaid.org/start/VoluntaryAcknowledgementOfParentage/voluntary_acknowledgement_of_paternity',
        'https://easyforms.illinoislegalaid.org/start/VoluntaryAcknowledgementOfParentage/voluntary_acknowledgement_of_paternity/#/1',
        'https://easyforms.illinoislegalaid.org/start/WhichProtectiveOrderIsRightForMe/which_protective_order',
        'https://easyforms.illinoislegalaid.org/start/WhichProtectiveOrderIsRightForMe/which_protective_order/#/1',
      ],
      init: () => {
        ...
        ilio.urls.forEach(url => {
          ...
          li.innerHTML = '<span>?</span><a href="'+url+'" target="_blank">'+url.replace('https://easyforms.illinoislegalaid.org/start/','')+'</a>';
